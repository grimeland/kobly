...
function DocumentArt() {
  return (
    <svg width="44" height="44" viewBox="0 0 53 53" fill="none" aria-hidden>
      <path
...
function BoxArt({ size = 36 }: { size?: number }) {
  return (
...
function CheckArt({
  ...
  return (
    <span className="relative inline-flex">
      ...
      {badge ? (
        <span className="absolute -right-1 -top-1 h-3 w-3 rounded-full bg-[#3D5507] ring-2 ring-surface" />
      ) : null}
    </span>
  );
}
  ...
  return (
    <section className="px-6 py-20 sm:px-10 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-6xl">
        <h2 className="font-serif text-3xl font-semibold text-ink sm:text-4xl lg:text-center">
          Slik fungerer det
        </h2>
