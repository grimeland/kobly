...
export function HeroCard({
  ...
  return (
    <div className="mx-auto w-full max-w-[400px] rounded-[14px] bg-surface-soft p-6 lg:p-7 shadow-[0_1px_2px_rgba(0,0,0,0.03),0_12px_32px_-16px_rgba(0,0,0,0.10)] ring-1 ring-black/[0.04]">
      ...
      <Link
        href={href}
        className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand px-6 py-4 text-base font-medium text-brand-ink transition-colors hover:bg-brand/90"
      >
        {cta}
